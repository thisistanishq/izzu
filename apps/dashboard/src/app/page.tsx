...
export default function Home() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-black text-white selection:bg-white selection:text-black overflow-x-hidden cursor-default"
    >
      <Preloader />
      ...
      <nav className="fixed top-0 w-full p-8 flex justify-between items-center z-40 mix-blend-difference">
        ...
        <div className="flex gap-8">
          ...
          <Link href="/login" className="hover:underline underline-offset-4 decoration-2">
            LOGIN
          </Link>
        </div>
      </nav>
      ...
      <section className="h-screen flex flex-col justify-center items-center px-4 relative">
        ...
        <h1
          ref={heroTextRef}
          className="text-[12vw] leading-[0.85] font-black tracking-tighter text-center mix-blend-overlay z-10 opacity-0"
        >
          IDENTITY <br />
          RECLAIMED
        </h1>
      ...
      <section className="min-h-screen flex items-center justify-center py-32 px-4">
        <div
          ...
          className="max-w-[1200px] w-full aspect-video bg-zinc-900 rounded-3xl overflow-hidden relative border border-white/10 group"
        >
          <div className="absolute inset-0 flex items-center justify-center bg-black/60 group-hover:bg-black/40 transition-all duration-500 z-20">
            <Link
              href="/login"
              className="px-12 py-5 bg-white text-black text-xl font-bold rounded-full hover:scale-110 transition-transform duration-300 flex items-center gap-3"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-xl text-zinc-400 leading-relaxed max-w-md">
              Your data never leaves your metal. We provide the mathematical engine. You provide the
              infrastructure. Zero probability of third-party breaches.
            </p>
          </div>
          <div className="md:pt-32">
            ...
            <p className="text-xl text-zinc-400 leading-relaxed max-w-md">
              Laplacian variance checks. 3D Mesh Depth analysis. Gaze tracking. Photos don't work.
              Videos don't work. Masks don't work.
            </p>
          </div>
        </div>
      </section>
